...
FOREIGN KEY (usuario) REFERENCES conta(conta_cliente)
);
...
INSERT INTO login_cliente(senha, usuario) VALUES ('1234', '12345');
INSERT INTO login_cliente(senha, usuario) VALUES ('2345', '23456');
